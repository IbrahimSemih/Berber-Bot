                ...
                <tbody>
                  {apts.map((apt, i) => (
                    <tr key={apt.id} className="border-b transition-colors" style={{ borderColor: "var(--border)" }}
                      ...
                      <td className="px-4 py-3 font-syne font-bold text-sm">{formatTime(apt.scheduled_at)}</td>
            ...
            <div className="p-4 flex flex-col">
              {apts.length === 0 ? (
                ...
                <div key={apt.id} className="flex gap-3 py-3 border-b last:border-0" style={{ borderColor: "var(--border)" }}>
                  <div className="text-xs font-syne font-bold w-10 flex-shrink-0 pt-0.5" style={{ color: "var(--text3)" }}>
