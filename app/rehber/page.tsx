      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="p-8 rounded-2xl border transition-all hover:-translate-y-1" style={{ background: "var(--bg2)", borderColor: "var(--border)" }}>
            ...
            <h2 className="text-xl font-bold mb-3">2. WhatsApp Entegrasyonu</h2>
            <p style={{ color: "var(--text2)" }} className="mb-4">
              WhatsApp numaranızı BerberBot'a bağlayarak müşterilerinizin bot üzerinden otomatik randevu almasını sağlayın.
            </p>
            <Link href="/whatsapp" className="text-sm font-medium hover:underline inline-flex items-center gap-2" style={{ color: "var(--accent)" }}>
              WhatsApp ayarlarına git <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="p-8 rounded-2xl border transition-all hover:-translate-y-1" style={{ background: "var(--bg2)", borderColor: "var(--border)" }}>
            ...
            <Link href="/settings" className="text-sm font-medium hover:underline inline-flex items-center gap-2" style={{ color: "var(--accent)" }}>
